    ...
    app: {
      ...
      premium: {
        ...
        cart: {
          ...
          emptyCopy: 'Agrega vinos publicados desde la cava. El checkout conserva totales calculados por backend.',
          ...
          onlinePaymentReady: 'El pago en línea se completa dentro de la app con Stripe Elements.',
        ...
        checkout: {
          ...
          optional: 'Opcional',
          promotionHelp: 'El backend valida que la promoción esté publicada, vigente y sea elegible.',
          createOrder: 'Crear orden',
          creatingOrder: 'Creando orden...',
          secureCard: 'Pago seguro con tarjeta',
          stripeCopy: 'Stripe captura los datos de tarjeta dentro de la app. Hacienda de Letras nunca guarda PAN ni CVV.',
          stripeUnavailable: 'Stripe Payment Element aún no está disponible. No se realizó ningún cobro.',
          acceptWebhook: 'Acepto que el backend y el webhook de Stripe validen el estado final del pago.',
        ...
        payment: {
          ...
          checking: 'Estamos consultando el estado real del pago con el backend.',
          successCopy: 'Tu pago se valida contra el backend y el webhook de Stripe.',
          failedCopy: 'La app no marca cobros como pagados. Puedes reintentar desde checkout si la orden sigue pendiente.',
        ...
        reservation: {
          ...
          guests: 'Personas',
          guestsHelp: 'El cupo se valida en backend',
      ...
      notificationsLoading: 'Consultando notificaciones reales...',
      notificationsEmpty: 'No hay notificaciones reales registradas.',
      notificationsError: 'No fue posible consultar las notificaciones reales.',
    ...
    app: {
      ...
      premium: {
        ...
        cart: {
          ...
          emptyCopy: 'Add published wines from the cellar. Checkout keeps backend-calculated totals.',
          ...
          onlinePaymentReady: 'Online payment is completed inside the app with Stripe Elements.',
        ...
        checkout: {
          ...
          optional: 'Optional',
          promotionHelp: 'The backend validates whether the promotion is published, active and eligible.',
          createOrder: 'Create order',
          creatingOrder: 'Creating order...',
          secureCard: 'Secure card payment',
          stripeCopy: 'Stripe securely captures card data inside the app. Hacienda de Letras never stores PAN or CVV.',
          stripeUnavailable: 'Stripe Payment Element is not available yet. No payment was collected.',
          acceptWebhook: 'I accept that the backend and Stripe webhook validate the final payment status.',
          payInApp: 'Pay in app',
        ...
        payment: {
          ...
          checking: 'We are checking the real payment status with the backend.',
          successCopy: 'Your payment is being validated against the backend and Stripe webhook.',
          failedCopy: 'No charge is marked as paid by the app. You can retry from checkout if the order is still pending.',
        ...
        reservation: {
          ...
          guests: 'Guests',
          guestsHelp: 'Capacity is validated by backend',
