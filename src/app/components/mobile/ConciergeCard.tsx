      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex h-[62px] w-[62px] items-center justify-center rounded-full border border-[rgba(215,173,96,0.8)] bg-[rgba(60,11,20,0.35)]">
            <img src="/faviconhacienda.svg" alt="Sommelier AI" className="h-8 w-8 object-contain brightness-[3]" />
          </div>
          <div>
        ...
        <button type="button" className="rounded-full border border-[rgba(215,173,96,0.9)] px-4 py-2 text-[14px] text-white">
          {isEnglish ? 'Chat' : 'Chatear'}
        </button>
      </div>
      <p className="mt-3 text-[14px] leading-6 text-[rgba(255,243,229,0.92)]">
        {isEnglish
