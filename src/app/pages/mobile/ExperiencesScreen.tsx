    ...
    <div className="ipad-experiences-screen space-y-6 px-[var(--app-pad)] pb-2 pt-3">
      ...
      <section className="space-y-3">
        ...
        <CrystalSelect
          ...
          ariaLabel={isEnglish ? 'Filter experiences by category' : 'Filtrar experiencias por categoría'}
      ...
      {loading ? (
        <section className="ipad-experiences-grid grid gap-3">
          ...
          {filteredExperiences.map((experience) => {
            ...
            return (
              <EditorialCard
                ...
                eyebrow={isEnglish ? 'Hacienda de Letras' : (textField(experience, 'category') || 'Hacienda de Letras')}
                title={title}
