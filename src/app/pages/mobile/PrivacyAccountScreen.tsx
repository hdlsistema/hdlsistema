  ...
  return (
    <div className="app-page space-y-6">
      ...
      <section className="rounded-[1.45rem] border border-[rgba(220,202,181,0.78)] bg-white p-5 shadow-[0_18px_38px_rgba(74,32,28,0.08)]">
        ...
        <div className="mt-5">
          <AppSectionHeader eyebrow="Mi cuenta" title="Privacidad y cuenta" subtitle="Consulta cómo tratamos tus datos y administra la eliminación de tu cuenta." />
        </div>
      </section>
      ...
      <section className="overflow-hidden rounded-[1.25rem] border border-[rgba(220,202,181,0.78)] bg-white shadow-[0_14px_30px_rgba(74,32,28,0.06)]">
        <a href="https://admhaciendadeletras.com/politica-de-privacidad" target="_blank" rel="noreferrer" className="flex items-center gap-3 px-4 py-4">
          ...
          <span className="min-w-0 flex-1"><span className="block text-[13px] font-semibold text-[var(--color-ink)]">Política de Privacidad</span><span className="mt-1 block text-[11px] leading-4 text-[var(--color-muted)]">Conoce el uso, protección y conservación de tus datos.</span></span>
        ...
        <div className="border-t border-[rgba(220,202,181,0.52)] px-4 py-4">
          <div className="flex items-start gap-3 rounded-[1rem] bg-[#fff8f1] p-4">
            ...
            <p className="text-[11px] leading-5 text-[var(--color-muted)]">La eliminación requiere confirmación y revisión. Cierta información podrá conservarse únicamente por obligación legal, fiscal, de seguridad o prevención de fraude.</p>
          </div>
        </div>
      </section>
      ...
      <Link to={appPath('/eliminar-cuenta')} className="flex min-h-14 items-center gap-3 rounded-[1.1rem] border border-[#e4bdb5] bg-[#fff4f1] px-4 text-[#963e32] shadow-[0_12px_24px_rgba(108,36,30,0.06)]">
        <Trash2 size={18} />
        <span className="min-w-0 flex-1"><span className="block text-[13px] font-semibold">Eliminar mi cuenta</span><span className="mt-1 block text-[11px] leading-4 text-[#8b625b]">Inicia una solicitud; tu cuenta no se elimina de inmediato.</span></span>
