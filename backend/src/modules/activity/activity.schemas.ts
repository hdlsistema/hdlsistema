...
const metadataSchema = z.object({
  ...
  itemType: z.enum(['wine', 'experience', 'event_ticket', 'membership', 'cabin', 'restaurant', 'quote_request']).optional(),
...
export const appActivityEventSchema = z.object({
  ...
  entityType: z.enum(['customer', 'wine', 'experience', 'event', 'service', 'cabin', 'restaurant', 'quote_request', 'membership', 'reservation', 'cart', 'cart_item', 'order', 'payment', 'map_poi']).nullable().optional(),
...
export const activityListQuerySchema = z.object({
  ...
  module: z.enum(['account', 'content', 'reservation', 'quote', 'cart', 'checkout', 'payment']).optional(),
  result: z.enum(['started', 'succeeded', 'failed', 'cancelled', 'processing']).optional(),
