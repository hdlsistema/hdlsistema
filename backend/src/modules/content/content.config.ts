...
export const contentConfigs: Record<ContentRouteEntity, ContentConfig> = {
  ...
  experiences: {
    ...
    adminSelect: '*',
    publicSelect:
      'id,slug,title,subtitle,description,short_description,duration_minutes,base_price,min_people,max_people,capacity,location,featured,status,cover_image_url,visible_in_app,sort_order,publish_at,unpublish_at,published_at,locale,version,metadata,experience_images(id,url,alt_text,sort_order,status,visible_in_app,publish_at,unpublish_at,archived_at,deleted_at)',
    publishStatus: 'published',
    unpublishStatus: 'inactive',
    archiveStatus: 'archived',
    restoreStatus: 'draft',
