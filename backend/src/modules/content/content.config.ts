...
export const contentConfigs: Record<ContentRouteEntity, ContentConfig> = {
  ...
  experiences: {
    ...
    adminSelect: '*',
    publicSelect:
      'id,slug,title,subtitle,description,short_description,duration_minutes,base_price,min_people,max_people,capacity,location,featured,status,cover_image_url,visible_in_app,sort_order,publish_at,unpublish_at,published_at,locale,version',
    publishStatus: 'published',
    unpublishStatus: 'inactive',
    archiveStatus: 'archived',
    restoreStatus: 'draft',
  ...
  events: {
    ...
    adminSelect: '*',
    publicSelect:
      'id,slug,title,subtitle,description,short_description,venue,start_at,end_at,capacity,sold_count,featured,status,visible_in_app,sales_enabled,cover_image_url,sort_order,publish_at,unpublish_at,published_at,locale,version',
    publishStatus: 'published',
    unpublishStatus: 'inactive',
    archiveStatus: 'archived',
    restoreStatus: 'draft',
