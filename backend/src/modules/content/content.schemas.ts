...
const campaignAudienceFiltersSchema = z
  .object({
    ...
    sourceGroup: z.enum(['app', 'web', 'hacienda', 'other']).optional(),
    location: z.string().trim().max(120).optional(),
    tagId: z.string().uuid().optional(),
    hasOrders: z.boolean().optional(),
    orderStatus: z.enum(['draft', 'pending_payment', 'paid', 'processing', 'fulfilled', 'cancelled', 'refunded']).optional(),
    hasReservations: z.boolean().optional(),
    hasMembership: z.boolean().optional(),
    cartStatus: z.enum(['active', 'abandoned', 'converted']).optional(),
    includeInternalUsers: z.boolean().optional(),
